...
/ralph-wiggum:ralph-loop "Optimize: [area]. DONE when: performance improved vs baseline, no functional regressions, benchmarks documented. Output <promise>COMPLETE</promise> when done." --completion-promise "COMPLETE" --max-iterations [estimated iterations]
```
